...
import com.mapbox.navigation.examples.basics.*
...
class MainActivity : AppCompatActivity(), PermissionsListener {
    ...
    private fun buildExamplesList(): List<MapboxExample> {
        return listOf(
            MapboxExample(
                ContextCompat.getDrawable(this, R.drawable.apptitle),
                getString(R.string.title_ghc),
                getString(R.string.description_ghc),
                GHCActivity::class.java
            ),
           /* MapboxExample(
